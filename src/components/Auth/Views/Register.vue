    ...
    <div class="wrapper wrapper-full-page ">
      <div class="full-page register-page section-image" filter-color="black">
              ...
              <div class="col-lg-4 col-md-6 mr-auto">
                <form @submit.prevent="registration">
                  <card type="signup" class="text-center">
                    ...
                    <p-checkbox v-model="form.acceptTerms" 
                                class="text-left" 
                    ...
                    <span v-show="!form.acceptTerms" class="text-danger">Termos e condições é obrigatório</span>

                    <p-button native-type="submit" 
                              @click.prevent="validate" 
                              slot="footer" 
                              type="success" 
                              round block class="mb-3">Cadastrar
                    </p-button>
                  </card>
                </form>
              </div>
        ...
        <div class="full-page-background"
             style="background-image: url(static/img/background/hsc.jpg) "></div>
      </div>
    </div>
  </div>
</template>
